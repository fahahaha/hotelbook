    ...
    <div class="layui-container">
        <div class="layui-row">
            <div class="layui-col-md-offset4 layui-col-md4" style="margin-top: 30px;margin-bottom: 50px;">
                ...
                <form name="mail" class="layui-form" action="${ctx}/mail/sendMail" method="get">
                    <h1 class="layui-input-block">欢 迎 登 录</h1>
                    <label class="layui-form-label" style="text-align: left;padding: 4px 5px;">会议名称:</label>
                    <div class="layui-form-item">
                        <input type="text" class="layui-input" name="meet_title" lay-verify="required" lay-reqtext="会议名称不能为空！" placeholder="请输入会议名称" <%--value="${loginUserName}"--%> />
                    </div>
                    <label class="layui-form-label" style="text-align: left;padding: 4px 5px;">开始时间:</label>
                    <div class="layui-form-item">
                        <input type="text" class="layui-input" name="meet_time" lay-verify="required" lay-reqtext="开始时间不能为空！" placeholder="请输入开始时间" <%--value="${loginUserName}"--%>/>
                    </div>
                    <label class="layui-form-label" style="text-align: left;padding: 4px 5px;">名字:</label>
                    <div class="layui-form-item">
                        <input type="text" class="layui-input" name="user_name" lay-verify="required" lay-reqtext="名字不能为空！" placeholder="请输入名字" <%--value="${loginUserName}"--%>/>
                    </div>
                    <label class="layui-form-label" style="text-align: left;padding: 4px 5px;">邮箱:</label>
                    <div class="layui-form-item">
                        <input type="text" class="layui-input" name="mails" lay-verify="required" lay-reqtext="邮箱不能为空！" placeholder="请输入邮箱" <%--value="${loginUserName}"--%>/>
                    </div>
